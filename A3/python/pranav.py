...
cnx = mysql.connector.connect(host='10.5.18.70',
                        ...
                        password='20CS10085')
cursor = cnx.cursor()
# Loop to take input from the user and execute the queries
while(1):
    # Take input from the user
    input_a = int(input("Enter a Query Number(Enter -1 to exit): "))
    if input_a==1:
        query = ("""
        ...
        # Get the results and store in a list
        res = list(cursor)
    ...
    WHERE Code = (SELECT Medication
        ...
        # Take procedure name as input from user
